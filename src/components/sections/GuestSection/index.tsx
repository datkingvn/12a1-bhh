...
export default function GuestSection() {
  ...
  } = useForm<GuestFormPayload>();
  const [, doCreateInvitation] = useRequest(apiService.createInvitation);

  const onSubmitForm: SubmitHandler<GuestFormPayload> = async (
    payload: GuestFormPayload
  ) => {
    try {
  ...
  return (
    ...
    >
      <div className={styles.content}>
        <div className={styles.title}>Thông tin tham gia</div>
        <div className={styles.description}>
          Nếu tới được thì điền zô đây chung vuii với tụi mìnhhh nèee!
        </div>
        <form onSubmit={handleSubmit(onSubmitForm)} className={styles.form}>
          <div className={styles.formItem}>
            <label className={styles.bold}>Tên của bạn là?</label>
            <input
              {...register("guestName", { required: "Bạn vui lòng điền tên!" })}
          ...
          <div className={styles.formItem}>
            <label className={styles.bold}>Bạn là khách mời của?</label>
            <div className={styles.choice}>
              <input
                {...register("relationship", {
                  required: "Bạn vui lòng cho biết thông tin mối quan hệ!",
                })}
                type={"radio"}
                ...
                id={"brideGuests"}
              />
              <label htmlFor={"brideGuests"}>Cô Tư xinh đẹp</label>
            </div>
            <div className={styles.choice}>
              <input
                {...register("relationship")}
                ...
                id={"groomGuests"}
              />
              <label htmlFor={"groomGuests"}>Lớp A1 báoo đốmm</label>
            </div>
            <div className={styles["text-error"]}>
          ...
          {/*</div>*/}
          <div className={styles.formItem}>
            <label className={styles.bold}>Bạn có thể tham dự chứ?</label>
            <div className={styles.choice}>
              <input
                {...register("willJoin", {
                  required: "Vui lòng cho biết quyết định tham dự của bạn!",
                })}
                type={"radio"}
                radioGroup={"willJoin"}
                value={"willJoin"}
                id={"willJoin"}
              />
              <label htmlFor={"willJoin"}>Có tham dự</label>
            </div>
            <div className={styles.choice}>
              <input
                {...register("willJoin")}
                ...
                id={"willNotJoin"}
              />
              <label htmlFor={"willNotJoin"}>Không tham dự</label>
            </div>
            <div className={styles["text-error"]}>
          ...
          <div className={styles.formItem}>
            ...
            <select
              ...
              disabled={String(watch("willJoin")) === "willNotJoin"}
